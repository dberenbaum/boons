...
Run `boons session-save --tool opencode --summary "..."` **automatically**
...
1. Run `boons session-read --tool opencode` to review the conversation
...
3. Run `boons session-save --tool opencode --summary "<summary>" \
