...
Run `boons session-save --tool claude-code --summary "..."` **automatically**
...
1. Run `boons session-read --tool claude-code` to review the conversation
...
3. Run `boons session-save --tool claude-code --summary "<summary>" \
